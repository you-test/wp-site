...
<!-- main visual -->
<div id="mv">
  <img src="<?php echo get_template_directory_uri(); ?>/furniture-img/chair_table1.jpg" alt="table&chair">
</div>
<!-- /main visual -->
...
<section id="item-list" class="container">
  ...
  <?php
      wp_pagenavi(array('query' => $table_query));
      wp_reset_postdata();
    ?>  
</section> 
<!--/news page  -->
