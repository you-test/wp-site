...
<!-- main visual -->
<div id="mv">
  <img src="<?php echo get_template_directory_uri(); ?>/furniture-img/bed1.jpg" alt="table&chair">
</div>
<!-- /main visual -->

<!-- news page -->
<section id="item-list" class="container">
  <h2 class="section-title">bed</h2>
  <div class="contents">
  ...
  <?php
      wp_pagenavi(array('query' => $bed_query));
      wp_reset_postdata();
    ?>  
</section> 
<!--/news page  -->
